...
var app = new Vue({
    ...
    methods: {
        ...
        _countPerSec: () => {
            ...
            // 限制处理
            if (app.money.lt(0)) {
                app.money = new BigNumber(0);
            }
            if (app.renown.lt(0)) {
                app.renown = new BigNumber(0);
            }
            if (app.standPoint.gt(10000)) {
                app.standPoint = new BigNumber(10000);
            } else if (app.standPoint.lt(-10000)) {
                app.standPoint = new BigNumber(-10000);
            }
        },
        _talentLvUp: () => {
